...
const CLASS_ASSETS_BUCKET = 'class-assets';
...
// Public: class photos are shown throughout the app to every signed-in
// account regardless of role — same reasoning as the school logo.
async function ensureClassAssetsBucket() {
  await ensureBucket(CLASS_ASSETS_BUCKET, {
    public: true,
    fileSizeLimit: 5 * 1024 * 1024,
    allowedMimeTypes: ['image/jpeg', 'image/png', 'image/webp'],
  });
...
module.exports = {
  ...
  CLASS_ASSETS_BUCKET,
  ensureAvatarBucket,
  ensureSchoolAssetsBucket,
  ensureClassAssetsBucket,
};
